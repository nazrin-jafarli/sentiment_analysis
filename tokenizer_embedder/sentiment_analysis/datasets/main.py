...
# Convert labels to one-hot encoded format
train_labels_one_hot = F.one_hot(train_labels, num_classes=num_classes).float()
val_labels_one_hot = F.one_hot(val_labels, num_classes=num_classes).float()
test_labels_one_hot = F.one_hot(test_labels, num_classes=num_classes).float()
...
for epoch in range(num_epochs):
    ...
    # print('outputs of classifier: ',outputs)
