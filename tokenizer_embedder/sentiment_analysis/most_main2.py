...
cluster_assignments_int = torch.tensor(cluster_assignments, dtype=torch.long)
print('cluster_assignments_int',cluster_assignments_int.dtype)

# Convert cluster assignments to one-hot encoded format
num_clusters = kmeans_semi_supervised.n_clusters
cluster_labels_one_hot = F.one_hot(cluster_assignments_int, num_classes=num_clusters)
