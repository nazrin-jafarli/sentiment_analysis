...
def train_sentencepiece_model(text_file, spm_model_prefix, vocab_size=16000, max_sentence_length=512):
    ...
    spm.SentencePieceTrainer.train(input=text, model_prefix=spm_model_prefix, vocab_size=vocab_size, character_coverage=0.9995, max_sentence_length=max_sentence_length, control_symbols=special_tokens, model_type="bpe")
